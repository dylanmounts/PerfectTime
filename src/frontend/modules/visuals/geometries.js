...
const hourHand = new THREE.ShapeGeometry(SHAPES.createClockHand(CONSTANTS.SIZES.HOUR_HAND_TIP_WIDTH, CONSTANTS.SIZES.HOUR_HAND_BASE_WIDTH, CONSTANTS.SIZES.HOUR_HAND_BASE_OFFSET, CONSTANTS.SIZES.HOUR_HAND_LENGTH_RATIO, CONSTANTS.SIZES.HOUR_HAND_SCALE));
const outerHourHand = new THREE.ShapeGeometry(SHAPES.createClockHand(CONSTANTS.SIZES.HOUR_HAND_TIP_WIDTH, CONSTANTS.SIZES.HOUR_HAND_BASE_WIDTH, CONSTANTS.SIZES.HOUR_HAND_BASE_OFFSET, CONSTANTS.SIZES.HOUR_HAND_LENGTH_RATIO));
const minuteHand = new THREE.ShapeGeometry(SHAPES.createClockHand(CONSTANTS.SIZES.MINUTE_HAND_TIP_WIDTH, CONSTANTS.SIZES.MINUTE_HAND_BASE_WIDTH, CONSTANTS.SIZES.MINUTE_HAND_BASE_OFFSET, CONSTANTS.SIZES.MINUTE_HAND_LENGTH_RATIO, CONSTANTS.SIZES.MINUTE_HAND_SCALE));
const outerMinuteHand = new THREE.ShapeGeometry(SHAPES.createClockHand(CONSTANTS.SIZES.MINUTE_HAND_TIP_WIDTH, CONSTANTS.SIZES.MINUTE_HAND_BASE_WIDTH, CONSTANTS.SIZES.MINUTE_HAND_BASE_OFFSET, CONSTANTS.SIZES.MINUTE_HAND_LENGTH_RATIO));
const secondHand = new THREE.ShapeGeometry(SHAPES.createClockHand(CONSTANTS.SIZES.SECOND_HAND_TIP_WIDTH, CONSTANTS.SIZES.SECOND_HAND_BASE_WIDTH, CONSTANTS.SIZES.SECOND_HAND_BASE_OFFSET, CONSTANTS.SIZES.SECOND_HAND_LENGTH_RATIO, CONSTANTS.SIZES.SECOND_HAND_SCALE));
const outerSecondHand = new THREE.ShapeGeometry(SHAPES.createClockHand(CONSTANTS.SIZES.SECOND_HAND_TIP_WIDTH, CONSTANTS.SIZES.SECOND_HAND_BASE_WIDTH, CONSTANTS.SIZES.SECOND_HAND_BASE_OFFSET, CONSTANTS.SIZES.SECOND_HAND_LENGTH_RATIO));
