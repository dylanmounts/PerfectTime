...
export const HOUR_HAND_BASE_LENGTH = SIZES.CLOCK_RADIUS * 5/8;
export const MINUTE_HAND_BASE_LENGTH = SIZES.CLOCK_RADIUS * 47/48;
export const SECOND_HAND_BASE_LENGTH = SIZES.CLOCK_RADIUS * 47/48;
